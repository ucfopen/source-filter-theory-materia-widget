 ...
 * @group Materia
 * @group Score
 * @group SourceFilterTheory
 */
class Test_Score_Modules_SourceFilterTheory extends \Basetest
{
	...
	protected function _makeWidget($partial = 'false')
	{
		...
		$title = 'SOURCE FILTER THEORY MODULE';
		$widget_id = $this->_find_widget_id('SourceFilterTheory');
